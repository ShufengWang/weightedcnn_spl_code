function d = rcnn_load_cached_softmax_features(experiment_dir, cache_name, imdb_name, id)
...
file = sprintf([experiment_dir 'feat_cache/%s/%s/%s'], cache_name, imdb_name, id);
file = [file '.mat'];
if exist(file, 'file')
  d = load(file);
else
